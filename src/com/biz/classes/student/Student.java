...
/*
 * 1. '학생' 정보를 알려주는 student클래스를 생성
 * 2. 학번, 이름, 입학년도, 전공, 학년 순으로,,, 학년 = 2019 - 입학년도 연산으로 구한다.
 * 3. 기능을 추가하시오.
 * 		가. 학생 개인의 정보를 보기
 * 		나. 학생 리스트 보기
 */
...
public class Student {
	 ...
	 * 		System.out.println("학년 : " + (2019 - intYear)); \\ 이러면 위 int intGrade가 사라져도 됨
	 * 
	 * public void list() {
	...
	public void StudentInformation() {
		intGrade = 2019 - admissionYear;
		System.out.println("-----------------------------------------------");
		System.out.println("학번 : " + strStudentId);
		System.out.println("이름 : " + strName);
		System.out.println("입학년도 : " + admissionYear);
